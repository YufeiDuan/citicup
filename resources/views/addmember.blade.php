...
<div id="myTabContent" class="tab-content">
   <div class="tab-pane fade in active" id="member">
      <form action="{{ URL('/member') }}" method="POST" onsubmit="return(checkadd())" name="formaddm">
            ...
            <br> 
            专业: <input type="text" name="major" class="form-control" required="required" value="" maxLength="20" required="required">
            <br>
            学号: <input type="text" name="stu_num" class="form-control" required="required" value="" maxLength="15" required="required">
            <br>
            身份证号: <input type="text" name="id_num" id="id_num" class="form-control" required="required" value="" maxLength="18" required="required">
            <br>
