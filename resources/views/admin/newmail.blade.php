<p>@extends('admin.mail')
	...
	<div class="container-fluid">
		<form class="form-horizontal" method="post" action="/admin/mail" onsubmit="return(send())">
			<div class="col-md-7">
				...
				<div class="row" style="font-size:15px;line-height:25px;">
					<div class="form-group">
						...
						<div class="col-md-10">
							<input type="text" name="subject" id="subject" class="form-control" maxlength="25" placeholder="此处输入邮件主题">
						</div>
					</div>
					<p>
			...
			<div class="col-md-4" style="border:solid 1px #dddddd;margin-left:15px;margin-top:20px;">
				选择收件人
					...
					<tbody>
						...
						<tr class="row">
							<td class="col-md-2">
								...
								<td class="col-md-10">{{$team->name}}</td>
							</tr>
							@endforeach
						</tbody>
					</table>
